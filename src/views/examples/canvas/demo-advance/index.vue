<template>
  <div>
    <div class="demo">
      <h2>line</h2>
      <canvas id="croppedPicture" width="500" height="300"></canvas>
      <canvas id="text" width="500" height="300"></canvas>
      <canvas id="shadow" width="500" height="340"></canvas>
      <canvas id="pattern" width="500" height="300"></canvas>
      <canvas id="gradient" width="500" height="300"></canvas>
