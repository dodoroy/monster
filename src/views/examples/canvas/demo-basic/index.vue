<template>
  <div>
    ...
    <canvas id="rect" width="500" height="300"></canvas>
    <canvas id="demo3" width="500" height="300"></canvas>

    <canvas id="demo4" width="500" height="300"></canvas>
<canvas id="translate" width="500" height="300"></canvas>
    <canvas id="transform" width="500" height="300"></canvas>
    <canvas id="composite" width="500" height="300"></canvas>
