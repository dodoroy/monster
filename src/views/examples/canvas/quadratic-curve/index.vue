<template>
  <div>
    <h1>this.canvas Quadratic Curve Example</h1>
    ...
    <p>
      This demonstration shows how quadratic curves can be drawn on a this.canvas element. Drag the line ends or the
      control point to change the curve.
    </p>
  </div>
</template>
<script>
